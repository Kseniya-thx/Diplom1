...
CREATE TABLE `departments` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_depart` FOREIGN KEY (`id`) REFERENCES `employees` (`id`)
...
INSERT INTO `departments` VALUES (1,'Отдел разработок'),(2,'Информационные технологии'),(3,'Бухгалтерия'),(4,'Директора'),(5,'Веб разработки');
